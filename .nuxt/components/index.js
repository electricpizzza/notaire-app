export { default as ActionTimeline } from '../../components/ActionTimeline.vue'
...
export { default as PersonForm } from '../../components/comparentComponents/PersonForm.vue'
...
export { default as Dossier } from '../../components/dossiers/Dossier.vue'
export { default as DossierCard } from '../../components/dossiers/DossierCard.vue'
export { default as DossierForm } from '../../components/dossiers/DossierForm.vue'

export const LazyActionTimeline = import('../../components/ActionTimeline.vue' /* webpackChunkName: "components/ActionTimeline" */).then(c => c.default || c)
export const LazyFormDialog = import('../../components/FormDialog.vue' /* webpackChunkName: "components/FormDialog" */).then(c => c.default || c)
export const LazyGroup = import('../../components/Group.vue' /* webpackChunkName: "components/Group" */).then(c => c.default || c)
...
export const LazyPersonForm = import('../../components/comparentComponents/PersonForm.vue' /* webpackChunkName: "components/comparentComponents/PersonForm" */).then(c => c.default || c)
...
export const LazyDossier = import('../../components/dossiers/Dossier.vue' /* webpackChunkName: "components/dossiers/Dossier" */).then(c => c.default || c)
export const LazyDossierCard = import('../../components/dossiers/DossierCard.vue' /* webpackChunkName: "components/dossiers/DossierCard" */).then(c => c.default || c)
export const LazyDossierForm = import('../../components/dossiers/DossierForm.vue' /* webpackChunkName: "components/dossiers/DossierForm" */).then(c => c.default || c)
